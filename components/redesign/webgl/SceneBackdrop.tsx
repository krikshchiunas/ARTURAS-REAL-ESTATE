...
const AboutPathScene = dynamic(() => import("@/components/redesign/webgl/AboutPathScene"), {
  ssr: false,
});
const ContactCubeScene = dynamic(() => import("@/components/redesign/webgl/ContactCubeScene"), {
  ssr: false,
});
