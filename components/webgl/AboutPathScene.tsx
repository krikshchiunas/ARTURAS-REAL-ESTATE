...
const CONFIG = {
  ...
  // Плавность камеры (меньше = ленивее). При 0.055 камера отставала от
  // прокрутки почти на секунду: читатель уже у последней карточки, а дорога
  // ещё едет — и продолжает ехать, когда листаешь дальше. 0.11 сохраняет
  // мягкость, но камера приезжает вместе с читателем.
  scrollSmooth: 0.11,
};
