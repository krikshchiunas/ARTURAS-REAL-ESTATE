...
export const projects: Project[] = [
  {
    ...
    payment:
      "Бронирование ฿100 000, первый платёж через 15 дней, далее гибкая рассрочка. Скидка 10% при полной оплате.",
    spec: [
  ...
  },
  {
    ...
    investment:
      "Годовая доходность от аренды 9–12%, рост стоимости при перепродаже через 3–5 лет — 20–50%. Управление и аренда обеспечиваются профессиональной командой; апартаменты с гостиничным управлением. Плата за обслуживание — 60 ฿/м² в месяц.",
    spec: [
